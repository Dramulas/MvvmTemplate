...
mixin _$ConfirmationInboxViewModel on _ConfirmationInboxViewModelBase, Store {
  ...
  final _$approveByPassFormAsyncAction =
      AsyncAction('_ConfirmationInboxViewModelBase.approveByPassForm');

  @override
  Future<dynamic> approveByPassForm(
      ApproveByPassModel model, BuildContext context) {
    return _$approveByPassFormAsyncAction
        .run(() => super.approveByPassForm(model, context));
  }

  final _$onTileClickAsyncAction =
      AsyncAction('_ConfirmationInboxViewModelBase.onTileClick');
  ...
  @override
  dynamic navigateToConfirmationDetailView(ByPassFormModel data) {
    final _$actionInfo =
        _$_ConfirmationInboxViewModelBaseActionController.startAction(
            name:
                '_ConfirmationInboxViewModelBase.navigateToConfirmationDetailView');
    try {
      return super.navigateToConfirmationDetailView(data);
    } finally {
      _$_ConfirmationInboxViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
  ...
  @override
  dynamic approveByPass(ByPassFormModel data, BuildContext context) {
    final _$actionInfo = _$_ConfirmationInboxViewModelBaseActionController
        .startAction(name: '_ConfirmationInboxViewModelBase.approveByPass');
    try {
      return super.approveByPass(data, context);
    } finally {
      _$_ConfirmationInboxViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
