...
import '../viewmodel/moc_technical_acceptance_view_model.dart';

class TechnicalAcceptanceView extends StatefulWidget {
  const TechnicalAcceptanceView({Key? key}) : super(key: key);

  @override
  _TechnicalAcceptanceViewState createState() =>
      _TechnicalAcceptanceViewState();
}

class _TechnicalAcceptanceViewState extends State<TechnicalAcceptanceView> {
  ...
  Widget build(BuildContext context) {
    return BaseView<TechnicalAcceptanceViewModel>(
      viewModel: TechnicalAcceptanceViewModel(),
      onModelReady: (TechnicalAcceptanceViewModel model) {
        model.setContext(context);
        model.init();
      },
      onPageBuilder:
          (BuildContext context, TechnicalAcceptanceViewModel viewModel) =>
              Scaffold(
        appBar: AppBar(
          elevation: 0,
        ),
  ...
  ListView buildListViewBuilder(
      List<TechnicalOAModel>? data, TechnicalAcceptanceViewModel viewModel) {
  ...
  Slidable buildSlidable(List<TechnicalOAModel> data, int index,
      TechnicalAcceptanceViewModel viewModel, BuildContext context) {
    return Slidable(
      ...
      secondaryActions: [
        Container(
          ...
          child: IconSlideAction(
            ...
            onTap: () {
              viewModel.navigateToTechnicalAcceptanceDetailView(
                data[index],
              );
            },
          ),
  ...
  GestureDetector buildColumn(
      TechnicalOAModel item, TechnicalAcceptanceViewModel viewModel) {
    return GestureDetector(
        onTap: () async {
          await viewModel.navigateToTechnicalAcceptanceDetailView(item);
        },
        child: Card(
                    ...
                    child: Column(
                      children: [
                        IconButton(
                          onPressed: () async {
                            await viewModel
                                .navigateToTechnicalAcceptanceDetailView(item);
                          },
