...
import '../../module/moc_contest_moc_form_button.dart';
import '../../module/moc_give_technical_acceptance_button.dart';
import '../../viewmodel/subviewmodel/moc_technical_acceptance_detail_view_model.dart';

class TechnicalAcceptanceDetailView extends StatefulWidget {
  const TechnicalAcceptanceDetailView({Key? key}) : super(key: key);

  @override
  State<TechnicalAcceptanceDetailView> createState() =>
      _TechnicalAcceptanceDetailViewState();
}

class _TechnicalAcceptanceDetailViewState
    extends State<TechnicalAcceptanceDetailView> {
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<TechnicalAcceptanceDetailViewModel>(
      viewModel: TechnicalAcceptanceDetailViewModel(),
      onModelReady: (TechnicalAcceptanceDetailViewModel model) {
        model.setContext(context);
        model.init();
      },
      onPageBuilder: (BuildContext context,
              TechnicalAcceptanceDetailViewModel viewModel) =>
          Scaffold(
        ...
        bottomNavigationBar: Padding(
          ...
          child: Row(
            ...
            children: [
              ContestMocFormButton(viewModel: viewModel, model: model),
              GiveTechnicalAcceptanceButton(viewModel: viewModel, model: model),
            ],
          ),
        ),
      ),
  ...
  Column buildColumn(BuildContext context,
      TechnicalAcceptanceDetailViewModel viewModel, TechnicalOAModel model) {
    return Column(
