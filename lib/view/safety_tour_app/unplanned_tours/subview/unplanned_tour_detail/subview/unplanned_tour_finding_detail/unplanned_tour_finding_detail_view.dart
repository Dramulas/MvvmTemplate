...
import '../../viewmodel/subview_model/unplanned_tour_detail_view_model/unplanned_tour_detail_view_model.dart';
            ...
            ActionButton(
              ...
              onPressed: () async {
                ...
                if (inputFiles != null && inputFiles.isNotEmpty) {
                  ...
                  final bulkUploadResult = await viewModel.uploadFindingFiles(
                      inputFiles, finding.id!, finding.tourId!);
                  setState(() {});
                  viewModel.changeIsFileLoading();
                  if (bulkUploadResult) {
                    final snackBar = SnackBar(
                      content: Text('Dosyalar başarıyla yüklendi.'),
