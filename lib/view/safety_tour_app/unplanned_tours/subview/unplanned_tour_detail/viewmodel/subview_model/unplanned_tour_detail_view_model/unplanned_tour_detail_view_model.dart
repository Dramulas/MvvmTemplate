...
abstract class _UnPlannedTourDetailViewModelBase with Store, BaseViewModel {
  ...
  Future<void> navigateToAddUnplannedTourFinding(TourModel tour) async {
  ...
  Future<dynamic> navigateToEditUnplannedTour(TourModel tour) {
    return NavigationService.instance.navigateToPage(
        NavigationConstants.EDIT_UNPLANNED_TOUR_VIEW,
        data: tour);
  }
