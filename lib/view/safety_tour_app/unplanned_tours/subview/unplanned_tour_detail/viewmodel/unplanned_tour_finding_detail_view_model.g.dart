...
mixin _$FindingDetailViewModel on _FindingDetailViewModelBase, Store {
  final _$isFileLoadingAtom =
      Atom(name: '_FindingDetailViewModelBase.isFileLoading');

  @override
  bool get isFileLoading {
    _$isFileLoadingAtom.reportRead();
    return super.isFileLoading;
  }

  @override
  set isFileLoading(bool value) {
    _$isFileLoadingAtom.reportWrite(value, super.isFileLoading, () {
      super.isFileLoading = value;
    });
  }
  ...
  @override
  Future<bool> uploadFindingFiles(List<File> files, int findingId, int tourId) {
  ...
  void changeIsFileLoading() {
    final _$actionInfo = _$_FindingDetailViewModelBaseActionController
        .startAction(name: '_FindingDetailViewModelBase.changeIsFileLoading');
    try {
      return super.changeIsFileLoading();
    } finally {
